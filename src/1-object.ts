...
// У випадку з type нам довелося б використовувати intersection (&).
...
// якщо ми передамо туди не той тип то отримаємо помилку

// let arr: Array<string | number> = [];

// arr = ["str", 10, true];  true немає, то видасть помилку

// export {};

// Розгляньмо ще один приклад, коли використання узагальнених типів стає просто необхідним.
// Це відбувається, коли ми працюємо з асинхронним кодом. Оскільки Promise може повернути абсолютно все, без дженерика ми ніколи не дізнаємось, що він повертає.
